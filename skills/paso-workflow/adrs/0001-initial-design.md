# 0001-Initial-Design-paso-workflow

## Status
Accepted

## Context
Se está creando la skill paso-workflow mediante el proceso de entrevista interactiva

## Decision
Usar el enfoque de entrevista interactiva para diseñar y crear la skill
